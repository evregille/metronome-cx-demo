...
export function SpendAlerts() {
    ...
    const handleToggle = () => { setIsSpendAlertOn(!isSpendAlertOn)}
        ...
        <div className={"relative flex flex-col overflow-hidden rounded-3xl border shadow-sm"}>
            <div className="min-h-[150px] items-start space-y-4 bg-muted/50 p-6">
                <p className="flex font-urban text-sm font-bold uppercase tracking-wider text-muted-foreground">
                    ...
                    {/* Switch */}
                    <div className="flex text-left text-3xl font-semibold leading-6 pt-[5%]">
                        <Switch 
                            checked={isSpendAlertOn} 
                    ...
                    {
                        isSpendAlertOn === true && 
                        <div className="flex text-left text-3xl font-semibold leading-6 align-middle">
                            <MetronomeAlertForm />
                        </div>
                    }
