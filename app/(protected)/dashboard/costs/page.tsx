...
export default function Costs() {
  ...
  const [groupValues, setGroupValues] = useState<Array<string>>(Object.keys(costs.products));
                  ...
                  <div className="grid grid-cols-3 gap-4 sm:grid-cols-3 xl:grid-cols-3">
                    <Select 
                      ...
                      <SelectContent >
                        ...
                        { costs.products && Object.keys(costs.products).length > 0 &&  Object.keys(costs.products).map((k:string) => {
                          return (
                    ...
                    <Select 
                      ...
                      <SelectContent >
                        ...
                        {selectedProduct !== 'all' && Object.keys(costs.products[selectedProduct]).length > 0 && Object.keys(costs.products[selectedProduct]).map((k:string) => {
                          return (
                            <SelectItem key={k} value={k}>
                              {k}
                            </SelectItem>
