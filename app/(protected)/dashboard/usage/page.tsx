...
export default function Usage() {
  ...
  const [groupValues, setGroupValues] = useState<Array<string>>(Object.keys(usage.products));
  ...
  const handleSelectProduct = (value: string) => {
    ...
    if(value === 'all') { // all products so we group by product
  ...
  return (
    <>
      <DashboardHeader
        heading="Usage"
        text="Track your usage in real time"
      />
          ...
          <div className="grid gap-2">
            ...
            <Select 
              ...
              <SelectContent >
                ...
                { usage.products && Object.keys(usage.products).length > 0 &&  Object.keys(usage.products).map((k:string) => {
                  return (
            ...
            <Select 
              ...
              <SelectContent >
                ...
                {selectedProduct !== 'all' && Object.keys(usage.products[selectedProduct]).length > 0 && Object.keys(usage.products[selectedProduct]).map((k:string) => {
                  return (
                    <SelectItem key={k} value={k}>
                      {k}
                    </SelectItem>
